...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      // Connor's pages defined in Strapi
      dynamicRoutes: {},
      // THe user object from Strapi
      user: undefined,
      // The drawer's open state
      open: false,
      // Whether or no auth0 has loaded
      authLoad: false,
      // Defined react router routes
      routes: {
  ...
  async componentDidMount() {
    ...
    // This was where I planned for Connor to add routes but he marches to his own drum
    this.setState({
      routes: {
        unlisted: [
          ...routes.unlisted,
  ...
  // Login in to Strapi with the user's Auth0 info
  handleStrapi(token) {
  ...
  render() {
    ...
    // Filter the routes based on various factors
    let filteredRoutes = {};
